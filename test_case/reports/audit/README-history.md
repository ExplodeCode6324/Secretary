...
实现结论、已知边界和未完成项见 [复核说明](../implementation/REVIEW_FIXES_20260922.md)。这些 fixture 测试经过真实 Pi 执行循环，但不调用在线模型；数据库测试使用实际 PostgreSQL。没有声称 LIVE_MODEL、REAL_USE、OS sandbox 或 Go/Pi 语义完全一致。
