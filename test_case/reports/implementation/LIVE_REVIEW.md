...
start:live 默认主会话 DeepSeek、执行者 Luna。模型调用会使用 API 配额；测试运行资料位于被忽略的 .demo-data/live，界面运行资料位于 .demo-data/interactive-live。凭据文件位置和停机方法见 [README.md](../../../docs/old/implementation-notes/README.md)。
