...
/**
 * 状态转换见 state_machine/catalog.json 的 Host
 */
export type HostState =
  ...
  | "DRAINING";
/**
 * 状态转换见 state_machine/catalog.json 的 Input
 */
...
/**
 * 状态转换见 state_machine/catalog.json 的 Call
 */
export type CallState =
  "PREPARED" | "IN_FLIGHT" | "RESPONSE_SAVED" | "INTERRUPTED" | "FAILED";
/**
 * 状态转换见 state_machine/catalog.json 的 Compaction
 */
...
/**
 * 状态转换见 state_machine/catalog.json 的 Plan
 */
...
/**
 * 状态转换见 state_machine/catalog.json 的 Execution
 */
export type ExecutionState =
  ...
  | "EXPIRED";
/**
 * 状态转换见 state_machine/catalog.json 的 Retention
 */
export type RetentionState = "HOT" | "ARCHIVE_PENDING" | "RETIRED";
/**
 * 状态转换见 state_machine/catalog.json 的 Feedback
 */
export type FeedbackState = "QUEUED" | "DELIVERED" | "HANDLED";
/**
 * 状态转换见 state_machine/catalog.json 的 Decision
 */
...
/**
 * 状态转换见 state_machine/catalog.json 的 Operation
 */
...
/**
 * 状态转换见 state_machine/catalog.json 的 Authorization
 */
export type AuthorizationState =
  "PENDING" | "APPROVED" | "REJECTED" | "REVOKED" | "EXPIRED" | "CONSUMED";
/**
 * 状态转换见 state_machine/catalog.json 的 Program
 */
export type ProgramState = "REGISTERED" | "ENABLED" | "DISABLED";
/**
 * 状态转换见 state_machine/catalog.json 的 Notification
 */
export type NotificationState =
  "QUEUED" | "SENDING" | "SENT" | "FAILED" | "DELIVERY_UNKNOWN";
/**
 * 状态转换见 state_machine/catalog.json 的 WorldCommand
 */
